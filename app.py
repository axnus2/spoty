...
def home():
    docs = {
        ...
        "usage_examples": {
            "curl": "curl 'https://your-app.onrender.com/sp/dl?url=https://open.spotify.com/track/56zZ48jdyY2oDXHVnwg5Di'",
            "python": "import requests\nresponse = requests.get('https://your-app.onrender.com/sp/dl', params={'url': 'https://open.spotify.com/track/56zZ48jdyY2oDXHVnwg5Di'})\nprint(response.json())"
        },
        "notes": [
...
# Remove the app.run() at the end - Render uses gunicorn
